...
(let* ((ad-comment       "#cd5c5c")  ; indian red
  ...
  (custom-theme-set-faces 'aerique-dark
    ...
    `(column-marker-1 ((t :foreground ,ad-darkest :background ,ad-gray-dark)))
    ...
    `(elfeed-search-date-face ,subdued)
    `(elfeed-search-feed-face ,subdued)
    `(elfeed-search-tag-face ,default)
    `(elfeed-search-title-face ,subdued)
    `(elfeed-search-unread-title-face ,default)
    ...
    `(fg:erc-color-face2 ,directory)  ; too dark otherwise
    ...
    ;`(font-lock-doc-face ,font-lock-comment-face)  ; see below …-string-face
    `(font-lock-function-name-face ,default)
    `(font-lock-keyword-face ,default)
    ;`(font-lock-keyword-face ,keyword)  ; too much noise in some PLs
    ...
    `(gnus-group-mail-2-empty ,subdued)
    `(gnus-group-mail-3 ,default)
    `(gnus-group-mail-3-empty ,subdued)
    `(gnus-group-mail-low ,subdued)
    `(gnus-group-mail-low-empty ,subdued)
    `(gnus-header-content ,keyword)
    `(gnus-header-name ,keyword)
    `(gnus-header-subject ,default)
    `(gnus-summary-normal-ancient ,subdued)
    `(gnus-summary-cancelled ,font-lock-comment-face)
    `(gnus-summary-normal-read ,font-lock-string-face)
    `(gnus-summary-normal-ticked ,keyword)
    `(gnus-summary-selected ,directory)
    ...
    `(jabber-chat-prompt-local ((t :foreground ,ad-keyword)))
    `(jabber-chat-prompt-foreign ((t :foreground ,ad-gray-light)))
    `(jabber-chat-prompt-system ((t :foreground ,ad-gray-light)))
    `(jabber-rare-time-face ((t :bold t :underline t)))
    ...
    `(match ,symlink)
    `(message-header-cc ,subdued)
    `(message-header-name ,font-lock-builtin-face)
    `(message-header-other ,subdued)
    ...
    `(powerline-active1 ((t :inherit mode-line :foreground ,ad-gray-lightest :background "grey22")))
    ...
    `(powerline-inactive1 ((t :inherit mode-line-inactive :foreground ,ad-gray-lightest :background "grey11")))
    `(pulse-highlight-start-face ((t :foreground ,ad-darkest :background ,ad-highlight)))
    ...
    `(twittering-username-face ,font-lock-builtin-face)
    `(warning ((t :foreground ,ad-highlight)))
    `(which-func ((t :foreground ,ad-gray-lightest)))
    `(whitespace-tab ((t :foreground ,ad-gray-dark)))
    `(wl-highlight-message-cited-text-2 ((t :foreground ,ad-gray-light)))
    `(wl-highlight-message-citation-header ((t :bold t :foreground ,ad-gray-light)))
    `(wl-highlight-message-header-contents ((t :inherit wl-highlight-message-headers)))
    `(wl-highlight-message-important-header-contents ((t :bold t :foreground ,ad-link)))
    `(wl-highlight-message-important-header-contents2 ((t :bold t :foreground ,ad-keyword)))
    `(wl-highlight-message-signature ((t :foreground ,ad-gray-dark)))
    `(wl-highlight-message-unimportant-header-contents ((t :inherit wl-highlight-message-headers)))
    `(wl-highlight-summary-answered-face ((t :foreground ,ad-keyword)))
    `(wl-highlight-summary-forwarded-face ((t :foreground ,ad-link)))
    `(wl-highlight-summary-new-face ((t :foreground ,ad-lightest)))
    `(wl-highlight-summary-normal-face ((t :foreground ,ad-gray-light)))
    `(wl-highlight-summary-thread-top-face ((t :foreground ,ad-gray-light)))
    ))
